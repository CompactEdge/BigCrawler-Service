        ...
        <div class="card sticky-card">
          <div class="card-body">
            <div class="input-group">
              ...
              <div class="col-md">
                <select class="selectpicker show-tick" data-width="100%" data-style="btn-primary">
                  <optgroup label="Type" data-max-options="1">
                    <option selected value="all">All Type</option>
                  </optgroup>
                  <option data-value="daemonset">DaemonSet</option>
                  <option data-value="statefulset">StatefulSet</option>
                  <option data-value="deployment">Deployment</option>
                </select>
              </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="material-datatables">
                ...
                <table id="rpods" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                  <thead></thead>
                  <tbody></tbody>
                </table>
