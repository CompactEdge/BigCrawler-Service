...
class KubernetesStatefulSet extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [], // not null
        ...
        <div className="content">
          <Row>
            <Col md="12">
              <Card>
                <CardHeader>
                  <CardTitle tag="h4">StatefulSet</CardTitle>
                  <p className="card-category">스테이트풀셋</p>
                </CardHeader>
                <CardBody>
                  <ReactTable
...
export default KubernetesStatefulSet;
