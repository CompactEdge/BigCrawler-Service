package com.wizontech.manoportal;

import com.wizontech.manoportal.config.security.Base64PasswordEncoder;
...
@SpringBootTest(classes = MANOPortalApplication.class)
class MANOPortalApplicationTests {
